...
const EvidencijaProfesionalneBolesti: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    const opt = {
      margin: 1,
      filename: 'evidencija_profesionalne_bolesti.pdf',
        ...
        <div className="p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-white dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 flex items-center gap-2 border border-gray-200"
            >
          ...
          <table className="min-w-full border border-gray-200 dark:border-white/[0.1]">
            <thead>
              <tr>
                ...
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] px-4 py-3 font-medium text-gray-700 dark:text-gray-400">Naziv radnog mesta na kom je zaposleni radio kada je utvrđena profesionalna bolest</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] px-4 py-3 font-medium text-gray-700 dark:text-gray-400">Ime i prezime obolelog od profesionalne bolesti</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] px-4 py-3 font-medium text-gray-700 dark:text-gray-400">Datum utvrđivanja profesionalne bolesti</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row, rowIdx) => (
