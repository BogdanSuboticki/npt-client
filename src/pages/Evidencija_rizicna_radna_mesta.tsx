...
const EvidencijaRizicnaRadnaMesta: React.FC = () => {
  ...
  const handlePrint = () => {
    ...
    const config = {
      title: 'Obrazac 1.',
      subtitle: 'Evidencija o radnim mestima sa povećanim rizikom, zaposlenih koji obavlja poslove na radnim mestima sa povećanim rizikom i lekarskim pregledima zaposlenih koji obavlja te poslove'
    };
