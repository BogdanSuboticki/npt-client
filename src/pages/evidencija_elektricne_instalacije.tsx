...
const EvidencijaElektricneInstalacije: React.FC = () => {
  const [rows, setRows] = useState<TableRow[]>(initialRows.map((row, index) => ({
    ...row,
    redniBroj: index + 1
  })));
  ...
  const handlePrint = () => {
    ...
    subtitle.textContent = 'Evidencija o izvršenim pregledima i ispitivanjima elekrtričnih i gromobranskih instalacija';
  ...
  const handleDownload = () => {
    ...
    const opt = {
      margin: 1,
      filename: 'evidencija_elektricne_instalacije.pdf',
          ...
          <table className="min-w-full border border-gray-200 dark:border-white/[0.1]">
            <thead>
              <tr>
                ...
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Podaci o električnim i gromobranskim instalacijama, čiji je pregled odnosno ispitivanje izvršeno</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Broj stručnog nalaza</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Datum pregleda, odnosno ispitivanja</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Datum sledećeg pregleda, odnosno ispitivanja</th>
                ...
                <React.Fragment key={idx}>
                  <tr>
                    ...
                    <td 
                      ...
                      onClick={() => handleCellClick(`podaciInstalacije-${idx}`)}
                    >
                      <input 
                        type="text" 
                        className="w-full h-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 px-4 py-3" 
                        value={row.podaciInstalacije} 
                        onChange={e => handleCellChange(idx, 'podaciInstalacije', e.target.value)}
                        ref={(el) => { inputRefs.current[`podaciInstalacije-${idx}`] = el; }}
                        data-input-key={`podaciInstalacije-${idx}`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] p-0 cursor-text"
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`brojStrucnogNalaza-${idx}`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] p-0 cursor-text"
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`datumPregleda-${idx}`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] p-0 cursor-text"
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`datumSledecegPregleda-${idx}`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] p-0 cursor-text"
                  ...
                  <tr>
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`brojStrucnogNalaza-${idx}-1`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-4 py-3 cursor-text"
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`datumPregleda-${idx}-1`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-4 py-3 cursor-text"
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`datumSledecegPregleda-${idx}-1`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-4 py-3 cursor-text"
                  ...
                  <tr>
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`brojStrucnogNalaza-${idx}-2`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-4 py-3 cursor-text"
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`datumPregleda-${idx}-2`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-4 py-3 cursor-text"
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`datumSledecegPregleda-${idx}-2`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-4 py-3 cursor-text"
                  ...
                  <tr>
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`brojStrucnogNalaza-${idx}-3`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-4 py-3 cursor-text"
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`datumPregleda-${idx}-3`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-4 py-3 cursor-text"
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`datumSledecegPregleda-${idx}-3`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-4 py-3 cursor-text"
...
export default EvidencijaElektricneInstalacije; 