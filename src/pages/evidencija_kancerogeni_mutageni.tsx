...
const EvidencijaKancerogeniMutageni: React.FC = () => {
  ...
  const handlePrint = () => {
    ...
    subtitle.textContent = 'Evidencija o zaposlenima koji su izloženi kancerogenima ili mutagenima, hemijskim materijama i azbestu, kao i o zdravstvenom stanju i izloženosti';
                ...
                <React.Fragment key={rowIdx}>
                  <tr>
                    ...
                    <td 
                      ...
                      rowSpan={5}
                      onClick={() => handleCellClick({ current: inputRefs.current[`nazivKancerogena-${rowIdx}`] })}
                    >
                      <input
                        ref={(el) => { inputRefs.current[`nazivKancerogena-${rowIdx}`] = el; }}
                        type="text"
                        ...
                        data-input-key={`nazivKancerogena-${rowIdx}`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-2 py-1 cursor-text" 
                      rowSpan={5}
                      onClick={() => handleCellClick({ current: inputRefs.current[`sabBroj-${rowIdx}`] })}
                    >
                      <input
                        ref={(el) => { inputRefs.current[`sabBroj-${rowIdx}`] = el; }}
                        type="text"
                        className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 whitespace-pre-wrap break-words min-h-[24px] cursor-text"
                        value={row.sabBroj}
                        onChange={e => handleCellChange(rowIdx, 'sabBroj', e.target.value)}
                        data-input-key={`sabBroj-${rowIdx}`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-2 py-1 cursor-text" 
                      rowSpan={5}
                      onClick={() => handleCellClick({ current: inputRefs.current[`esBroj-${rowIdx}`] })}
                    >
                      <input
                        ref={(el) => { inputRefs.current[`esBroj-${rowIdx}`] = el; }}
                        type="text"
                        className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 whitespace-pre-wrap break-words min-h-[24px] cursor-text"
                        value={row.esBroj}
                        onChange={e => handleCellChange(rowIdx, 'esBroj', e.target.value)}
                        data-input-key={`esBroj-${rowIdx}`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-2 py-1 cursor-text" 
                      rowSpan={5}
                      onClick={() => handleCellClick({ current: inputRefs.current[`klasaOpasnosti-${rowIdx}`] })}
                    >
                      <input
                        ref={(el) => { inputRefs.current[`klasaOpasnosti-${rowIdx}`] = el; }}
                        type="text"
                        className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 whitespace-pre-wrap break-words min-h-[24px] cursor-text"
                        value={row.klasaOpasnosti}
                        onChange={e => handleCellChange(rowIdx, 'klasaOpasnosti', e.target.value)}
                        data-input-key={`klasaOpasnosti-${rowIdx}`}
                      />
                    </td>
                    ...
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-2 py-1 cursor-text" 
                      rowSpan={5}
                      onClick={() => handleCellClick({ current: inputRefs.current[`izlozenost-${rowIdx}`] })}
                    >
                      <input
                        ref={(el) => { inputRefs.current[`izlozenost-${rowIdx}`] = el; }}
                        type="text"
                        className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 whitespace-pre-wrap break-words min-h-[24px] cursor-text"
                        value={row.izlozenost}
                        onChange={e => handleCellChange(rowIdx, 'izlozenost', e.target.value)}
                        data-input-key={`izlozenost-${rowIdx}`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] px-2 py-1 cursor-text" 
