...
const EvidencijaPreglediOpreme: React.FC = () => {
  ...
  const handlePrint = () => {
    ...
    subtitle.textContent = 'Evidencija o izvršenim pregledima i proverama opreme za rad';
          ...
          <table className="min-w-full border border-gray-200 dark:border-white/[0.1]">
            <thead>
              <tr>
                ...
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Podaci o opremi za rad čiji je pregled, odnosno provera izvršena (vrsta, fabrički broj, godina proizvodnje, lokacija i namena)</th>
                ...
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Datum pregleda, odnosno provere</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Datum sledećeg pregleda, odnosno provere</th>
                  ...
                  <tr>
                    ...
                    >
                      <input 
                        ...
                        data-input-key={`podaciOpreme-${idx}`}
                      />
                    </td>
                    <td 
                      className="border border-gray-200 dark:border-white/[0.1] p-0 cursor-text"
...
export default EvidencijaPreglediOpreme; 