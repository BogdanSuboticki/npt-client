    ...
    <div className="py-8">
      <div className="flex-row md:flex-row md:justify-between md:items-center mb-6 gap-4">
        ...
        <h2 className="text-lg text-gray-400 dark:text-white">
          EVIDENCIJA O PRIMENI MERA ZA BEZBEDNOST I ZDRAVLJE NA RADU<br />
          ZA DELATNOSTI IZ ČLANA 48. ZAKONA O BEZBEDNOSTI I ZDRAVLJU NA RADU
        </h2>
      </div>
            ...
            <tbody>
              ...
              <tr>
                <td className="border border-gray-200 dark:border-white/[0.1] px-4 py-3">
                  <input type="text" className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400" value={godina} onChange={e => setGodina(e.target.value)} />
                </td>
                <td className="border border-gray-200 dark:border-white/[0.1] px-4 py-3">
                  <input type="text" className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400" value={mesec} onChange={e => setMesec(e.target.value)} />
                </td>
                <td className="border border-gray-200 dark:border-white/[0.1] px-4 py-3">
                  <input type="text" className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400" value={lokacija} onChange={e => setLokacija(e.target.value)} />
                </td>
              </tr>
              ...
              {rows.slice(0, itemsPerPage).map((row, idx) => (
                <tr key={idx}>
                  <td className="border border-gray-200 dark:border-white/[0.1] px-4 py-4 text-center text-[13px] text-gray-800 dark:text-gray-400">{idx + 1}.</td>
                  <td className="border border-gray-200 dark:border-white/[0.1] px-4 py-4">
                    <input type="text" className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400" value={row.nepravilnosti} onChange={e => handleRowChange(idx, 'nepravilnosti', e.target.value)} />
                  </td>
                  <td className="border border-gray-200 dark:border-white/[0.1] px-4 py-4">
                    <input type="text" className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400" value={row.lice} onChange={e => handleRowChange(idx, 'lice', e.target.value)} />
                  </td>
                  <td className="border border-gray-200 dark:border-white/[0.1] px-4 py-4">
                    <input type="text" className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400" value={row.predlog} onChange={e => handleRowChange(idx, 'predlog', e.target.value)} />
                  </td>
                  <td className="border border-gray-200 dark:border-white/[0.1] px-4 py-4">
                    <input type="text" className="w-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400" value={row.napomena} onChange={e => handleRowChange(idx, 'napomena', e.target.value)} />
                  </td>
                </tr>
              ))}
            </tbody>
