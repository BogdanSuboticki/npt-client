...
const EvidencijaZastitnaOprema: React.FC = () => {
  ...
  const handlePrint = () => {
    ...
    subtitle.textContent = 'Evidencija o izdatoj ličnoj zaštitnoj opremi';
  ...
  const handleDownload = () => {
    ...
    const opt = {
      margin: 1,
      filename: 'evidencija_zastitna_oprema.pdf',
    ...
    <div className="py-8">
      <div className="flex-row md:flex-row md:justify-between md:items-center mb-6 gap-4">
        ...
        <h2 className='text-lg text-gray-400 dark:text-white mt-2'>
          Evidencija o izdatoj ličnoj zaštitnoj opremi
        </h2>
      </div>
          ...
          <table className="min-w-full border border-gray-200 dark:border-white/[0.1]">
            <thead>
              <tr>
                ...
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Podaci o ličnoj zaštitnoj opremi prema aktu o proceni rizika (vrsta, oznaka standarda i dr.)</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Radno mesto</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Datum izdavanja</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Rok trajanja (ako postoji prema uputstvu proizvođača)</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Ime i prezime lica koje je izdalo ličnu zaštitnu opremu</th>
                <th className="border border-gray-200 dark:border-white/[0.1] text-[13px] font-medium text-gray-700 dark:text-gray-400 px-4 py-3">Naziv dokumenta o zaduženju lične zaštitne opreme (revers, karton zaduženja, otpremnica i sl.)</th>
              </tr>
            </thead>
            <tbody>
              {rows.slice(0, itemsPerPage).map((row, idx) => (
                <tr key={idx}>
                  <td className="border border-gray-200 dark:border-white/[0.1] text-center text-[13px] text-gray-800 dark:text-gray-400 px-4 py-3">{row.redniBroj}.</td>
                  <td className="border border-gray-200 dark:border-white/[0.1] p-0">
                    <input type="text" className="w-full h-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 px-4 py-3" value={row.podaciOpreme} onChange={e => handleCellChange(idx, 'podaciOpreme', e.target.value)} data-input-key={`podaciOpreme-${idx}`} />
                  </td>
                  <td className="border border-gray-200 dark:border-white/[0.1] p-0">
                    <input type="text" className="w-full h-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 px-4 py-3" value={row.radnoMesto} onChange={e => handleCellChange(idx, 'radnoMesto', e.target.value)} data-input-key={`radnoMesto-${idx}`} />
                  </td>
                  <td className="border border-gray-200 dark:border-white/[0.1] p-0">
                    <input type="text" className="w-full h-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 px-4 py-3" value={row.datumIzdavanja} onChange={e => handleCellChange(idx, 'datumIzdavanja', e.target.value)} data-input-key={`datumIzdavanja-${idx}`} />
                  </td>
                  <td className="border border-gray-200 dark:border-white/[0.1] p-0">
                    <input type="text" className="w-full h-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 px-4 py-3" value={row.rokTrajanja} onChange={e => handleCellChange(idx, 'rokTrajanja', e.target.value)} data-input-key={`rokTrajanja-${idx}`} />
                  </td>
                  <td className="border border-gray-200 dark:border-white/[0.1] p-0">
                    <input type="text" className="w-full h-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 px-4 py-3" value={row.imePrezime} onChange={e => handleCellChange(idx, 'imePrezime', e.target.value)} data-input-key={`imePrezime-${idx}`} />
                  </td>
                  <td className="border border-gray-200 dark:border-white/[0.1] p-0">
                    <input type="text" className="w-full h-full outline-none bg-transparent text-[13px] text-gray-800 dark:text-gray-400 px-4 py-3" value={row.nazivDokumenta} onChange={e => handleCellChange(idx, 'nazivDokumenta', e.target.value)} data-input-key={`nazivDokumenta-${idx}`} />
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        >
          <div className="text-center">
            ...
            <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
              Smanjivanjem broja redova biћe uklonjen текст у пољима која више неће бити видљива. Да ли сте сигурни да желите да наставите?
            </p>
...
export default EvidencijaZastitnaOprema; 