                    ...
                    <DatePicker
                      ...
                      slotProps={{
                        textField: {
                          ...
                          className: "w-full px-4 text-sm bg-[#F9FAFB] rounded-lg dark:bg-[#101828]",
                          sx: {
                    ...
                    <DatePicker
                      ...
                      slotProps={{
                        textField: {
                          ...
                          className: "w-full px-4 text-sm bg-[#F9FAFB] border border-gray-300 rounded-lg dark:bg-[#101828] dark:border-gray-700",
                          sx: {
                            "& .MuiOutlinedInput-root": {
                              height: "44px",
                              cursor: "pointer",
